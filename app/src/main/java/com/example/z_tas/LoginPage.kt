...
import com.example.z_tas.network.AssertionResponseBody
import com.example.z_tas.network.BeginLoginRequest
import com.example.z_tas.network.FinishLoginRequest
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun buildGetCredentialJson(
        begin: com.example.z_tas.network.BeginLoginResponse
    ): String {
        val json = JSONObject()
